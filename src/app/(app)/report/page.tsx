          ...
          <div className="flex flex-wrap gap-4 items-end">
            <div>
              ...
              <select
                ...
                onChange={(e) => { setSelectedTeamId(e.target.value); setReport(null); }}
        ...
        <div className="bg-white rounded-lg shadow p-6 print:shadow-none print:p-0">
          ...
          {batters.length > 0 && (
            <section className="mb-8">
              <h3 className="text-lg font-bold mb-3 text-green-800 border-b border-green-200 pb-1">
                Batters
              </h3>
              <div className="space-y-6">
                {batters.map((r) => (
          ...
          {pitchers.length > 0 && (
            <section className="mb-8">
              <h3 className="text-lg font-bold mb-3 text-blue-800 border-b border-blue-200 pb-1">
                Pitchers
              </h3>
              <div className="space-y-6">
                {pitchers.map((r) => (
          ...
          {allAwards.length > 0 && (
            <section className="mb-4">
              <h3 className="text-lg font-bold mb-3 text-yellow-800 border-b border-yellow-200 pb-1">
                Special Awards
              </h3>
        ...
        <div className="flex items-center gap-2">
          ...
          {!result.scoring.qualified && (
            <span className="text-xs text-red-600 font-medium">
              DQ: {result.scoring.disqualificationReason}
            </span>
          )}
        </div>
